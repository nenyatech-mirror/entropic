...
const MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  "venice/openai-gpt-55-pro": { input: 4500, output: 27000 },
  "venice/kimi-k2-6": { input: 102, output: 560 },
  "venice/claude-opus-4-7": { input: 720, output: 3600 },
  "venice/deepseek-v4-pro": { input: 208, output: 456 },
  "venice/deepseek-v4-flash": { input: 21, output: 42 },
  "venice/deepseek-v3.2": { input: 40, output: 58 },
  "venice/zai-org-glm-5-1": { input: 210, output: 660 },
  "venice/grok-4-3": { input: 171, output: 340 },
